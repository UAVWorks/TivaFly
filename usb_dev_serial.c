...
//*****************************************************************************
unsigned long
USBControlHandler(void *pvCBData, unsigned long ulEvent,
               unsigned long ulMsgValue, void *pvMsgData)
{
    ...
    switch(ulEvent)
    {
        ...
        case USBD_CDC_EVENT_GET_LINE_CODING:
        	...
        	memcpy(pvMsgData,&ConfigLinea,sizeof(ConfigLinea));//Como es un puerto emulado, respondo con la configuración memorizada.
            break;
...
//*****************************************************************************
unsigned long
USBTxHandler(void *pvCBData, unsigned long ulEvent, unsigned long ulMsgValue,
          void *pvMsgData)
{
	unsigned char cChar;
...
//
//*****************************************************************************
unsigned long USBRxHandler(void *pvCBData, unsigned long ulEvent, unsigned long ulMsgValue,
          void *pvMsgData)
{
